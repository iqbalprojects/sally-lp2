...
function App() {
    ...
    const sections = ["Home", "About", "Specialties", "Experience", "Roadmap"];
        ...
        const handleScroll = () => {
            ...
            [...sections, "Feature"].forEach((sectionId) => {
                ...
                const visibleTop = Math.max(
                    0,
                    Math.min(viewportMiddle, rect.bottom) -
                        Math.max(0, rect.top)
                );
            ...
            if (bestVisibleSection && bestVisibility > 0.1) {
                // Only update if reasonably visible
