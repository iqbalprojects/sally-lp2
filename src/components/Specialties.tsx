...
const Specialties = () => {
    return (
        <div id="Specialties" className="custom-bg">
        ...
        ">
                ...
                <div className="relative max-h-[1472px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 space-y-[24px] md:space-y-0 gap-[24px]">
                    <div
                        ...
                        className="w-full max-h-[350px] rounded-[12px] border border-white/10 p-[32px] space-y-[20px] flex flex-col items-center bg-white/5"
                    >
                        ...
                        <div className="flex flex-col items-center space-y-[12px]">
                            ...
                            <p className="font-manrope text-[16px] font-normal leading-[21.86px] text-[#FFFFFF99] text-center">
                                Sally provides evidence-based, personalized
                                health guidance tailored to your unique needs
                                and lifestyle.
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center space-y-[12px]">
                            ...
                            <p className="font-manrope text-[16px] font-normal leading-[21.86px] text-[#FFFFFF99] text-center">
                                Sally uses $A1C as her primary distribution
                                means to reach out to users.
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center space-y-[12px]">
                            ...
                            <p className="font-manrope text-[16px] font-normal leading-[21.86px] text-[#FFFFFF99] text-center">
                                Sally takes a comprehensive approach to health,
                                covering nutrition, fitness, mental well-being,
                                and more.
                            </p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center space-y-[12px]">
                            ...
                            <p className="font-manrope text-[16px] font-normal leading-[21.86px] text-[#FFFFFF99] text-center">
                                Ask questions, upload medical documents, and
                                receive actionable insights—all in one seamless
                                platform.
                            </p>
                        </div>
                    </div>
