...
import GrainyBg from "../assets/grainy-gradient-bg.webp";
...
const About = () => {
    ...
    return (
        <div
            id="About"
            className="py-[120px] px-[16px] bg-about lg:bg-aboutTablet bg-cover bg-center relative flex justify-center md:px-[40px] md:py-[120px]"
        >
            <div
