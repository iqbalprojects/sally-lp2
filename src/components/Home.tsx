  ...
  return (
    ...
    >
      <div
           ...
           ></div>
      {/* Header */}
      <div className={`${scrollPosition > 50 ? 'bg-black/50 backdrop-blur-sm' : 'bg-transparent'} min-w-[375px] flex items-center justify-between px-[16px] py-[9px] md:px-[40px] md:py-[26px] fixed top-0 w-full z-40`}>
      ...
      {/* Main Content */}
      <div data-aos="fade-up" data-aos-duration="1000" className="min-h-[454px] container mx-auto w-full pt-[50px] px-[16px] grid grid-cols-1 gap-[32px] place-items-center">
      ...
      {/* Hero Image */}
      <div data-aos="fade-up" data-aos-duration="1000" className="absolute md:-bottom-20 left-0 -translate-x-0 mx-auto w-full flex justify-center">
        <img
          src={Hero}
          width={375}
          height={771}
